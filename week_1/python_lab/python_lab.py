...
## Task 2
remainder_without_mod = 2304811 - (2304811//47)
...
## Task 17
L1 = [0,1,2,3,1] # <-- want len(L1) != len(list(set(L1)))
...
## Task 20
list_sum_zip = [[10,25,40][i]+[1,15,20][i] for i in range(len([10,25,40])) for j in range(len([1,15,20])) if i == j]
...
## Task 23
square_dict = {i:i**2 for i in list(range(0,100))}
